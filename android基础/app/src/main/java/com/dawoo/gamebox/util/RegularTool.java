...
public class RegularTool {
    ...
    public static boolean isMobilePhone(String s){
        ...
        Pattern p = Pattern
                .compile("^((13[0-9])|(15[^4,\\D])|(18[0-9])|(145)|(147)|(17[0-9]))\\d{8}$");
    ...
    public static String deleteNoNumber(String value){
        ...
        if (StringTool.isEmpty(value)) return "";
        Pattern p = Pattern
                .compile("[^0-9.]");
        Matcher m = p.matcher(value);
    ...
    public static boolean isCard(String cardNum){
        ...
        if (StringTool.isEmpty(cardNum) || (cardNum.length() != 15 && cardNum.length() != 18)) return false;
