...
import com.dawoo.gamebox.mvp.view.ISysNoticeView;
...
public class SysNoticeFragment extends BaseFragment implements ISysNoticeView, OnLoadMoreListener {
    ...
    private void initData() {
        ...
        //mTImeZone = (String) SPTool.get(mContext, ConstantValue.KEY_TIME_ZONE, TimeZone.getDefault());
    ...
    class SysNoticeAdapter2 extends BaseQuickAdapter {
        ...
        protected void convert(BaseViewHolder helper, Object item) {
            ...
            if (bean != null) {
                helper.setText(R.id.content, "\t\t" + bean.getContent());
                ...
                helper.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(MessageDetailActivity.TYPE_NOTICE, MessageDetailActivity.SYS_NOTICE);
                        intent.putExtra(MessageDetailActivity.DETAIL_ID, bean.getSearchId());
