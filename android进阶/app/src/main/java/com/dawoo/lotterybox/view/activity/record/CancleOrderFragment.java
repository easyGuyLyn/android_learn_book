...
public class CancleOrderFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, INoteRecordHisView {
    private static final int CHOOSE_CALENDAR_REQUEST_CODE = 003;
    Unbinder unbinder;
    ...
    public static final String prized_stop = "prized_stop";//系统撤销
    public static final String[] status = new String[]{all, revoke_sys, revoke_self, prized_stop};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_history_cancel_order_form, container, false);
    ...
    private void initViews() {
        mTabStatusArray = getResources().getStringArray(R.array.cancel_tab_status);
    ...
    @OnClick({R.id.rl_actionTheDayBefore, R.id.rl_ActionCalendar, R.id.rl_actionTheDayAfter, R.id.rl_action_allCode, R.id.rl_action_note_sort, R.id.rl_action_time_sort})
...
//                , mQueryStartDate, mQueryEndDate, mPageSize + "", mPageNumber + "", "");
    ...
    public void onAssetsResult(Object o) {
        ...
        mUnopenPrizeAmount.setText(assetsBean.getUpOpen() + "");
        mCancelOrder.setText(assetsBean.getRevoke() + "");

        //上面日历
        mTvYinKuiDayBefore.setText(getString(R.string.account_cancelOrder, assetsBean.getBeforeProfit() + ""));
        mTvYinKuiDayAfter.setText(getString(R.string.account_cancelOrder, assetsBean.getAfterProfit() + ""));
        mTvYinKuiMd.setText(getString(R.string.account_cancelOrder, assetsBean.getProfit() + ""));
