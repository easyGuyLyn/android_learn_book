...
public class SSC_SZDW_Fragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initViews();
        initData(getString(R.string.wqb));
        initListener();
        return v;
    }
    ...
    private void initViews() {
        mList = CQSSCBDataUtils.initSZDWData();
        initTab();
    }
    ...
    private void initData(String tab) {
        for (PlayTypeBean.PlayBean playBean : mList) {
            ...
            for (String childType : childTypes) {
                listLinkedHashMap.put(childType, CQSSCBDataUtils.init_SZDW_0_9_Data(
    ...
    private class MainAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            tv_play_type_name.setText(titleList.get(position));
