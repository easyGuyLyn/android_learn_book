...
public class CQSSCGFWanFaUtil {
    ...
    public static PlayTypeBean.PlayBean initFirstTypeData(){
        ...
        playBean1.setSample("投注方案：345 开奖号码后三位：345，即中后三位直选。");
    ...
    private void initDDWData(){
        ...
        playBean1.setSample("投注方案：万位1 开奖号码：万位1，即中定位胆万位。");
    ...
    private void initWXData(){
        ...
        playBean1.setSample("投注方案：13456 开奖号码：13456，即中五星直选。");
        ...
        playBean2.setSample("投注方案：23456 开奖号码：23456，即中五星直选。");
    ...
    private void initSXData(){
        ...
        playBean1.setSample("投注方案：3456 开奖号码后四位：3456，即中四星直选。");
    ...
    private void initHSData(){
        ...
        playBean2.setSample("投注方案：345开奖号码：345，即中后三直选。");
        ...
        playBean3.setSample("投注方案：购买：6+7+8，由以下三注：678(三星)、78(二星)、8(一星)构成 开奖号码：678，即可中奖 一星、二星、三星各一注。");
        ...
        playBean4.setSample("投注方案：和值：1，开奖号码：后三位001、010、100，即中后三直选。");
        ...
        playBean5.setSample("投注方案：跨度：8，开奖号码：**129，最大号码9与最小号码1相减值等于8，所选号与跨度号码相同即中奖。");
        ...
        playBean6.setBetCode("ssc_sanxing_zhixuan_hsfs");

        playBean6.setSample("规则 投注方案：588开奖号码：后三位588(顺序不限)，即可中后三组选三。");
        ...
        playBean7.setSample("投注方案：001 开奖号码：后三位010(顺序不限)，即中后三组选三。");
        ...
        playBean8.setSample("投注方案：258开奖号码：后三位852(顺序不限)，即可中后三组选六。");
        ...
        playBean9.setSample("投注方案：123 开奖号码：后三位321(顺序不限)，即中后三组选六。");
        ...
        playBean10.setSample("投注方案：001和123 开奖号码：后三位010(顺序不限)，即中后三组选三，或后三位312(顺序不限)，即中后三组选六。");
        ...
        playBean11.setSample("投注方案：和值：3，开奖号码：后三位003(顺序不限)，即中后三组选三，或者后三位012(顺序不限)即中后三组选六。");
        ...
        playBean12.setSample("投注方案：包胆3：开奖号码：后三位3XX或者33X，即中后三组选三，后三位3XY，即中后三组选六");
        ...
        layoutBean18.setShowRightMenuType(0);
        ...
        playBean13.setSample("投注方案：和值尾数8 开奖号码：后三位936，和值尾数为8，即中和值尾数。");
        ...
        playBean14.setSample("投注方案：豹子顺子对子 开奖号码：后三位888，即中豹子；后三位678，即中顺子；后三位558，即中对子。");
    ...
    private void initQSData(){
        ...
        playBean1.setSample("投注方案：345 开奖号码前三位：345，即中前三位直选。");
        ...
        playBean2.setSample("投注方案：345开奖号码：345，即中前三直选。");
        ...
        playBean4.setSample("投注方案：和值：1，开奖号码：前三位001、010、100，即中前三直选。");
        ...
        playBean7.setSample("投注方案：001 开奖号码：前三位010(顺序不限)，即中前三组选三。");
        ...
        playBean8.setSample("投注方案：258开奖号码：前三位852(顺序不限)，即可中前三组选六。");
        ...
        playBean9.setSample("投注方案：123 开奖号码：前三位321(顺序不限)，即中前三组选六。");
        ...
        playBean10.setSample("投注方案：001和123 开奖号码：前三位010(顺序不限)，即中前三组选三，或前三位312(顺序不限)，即中前三组选六。");
        ...
        playBean11.setSample("投注方案：和值：3，开奖号码：前三位003(顺序不限)，即中前三组选三，或者前三位012(顺序不限)即中前三组选六。");
        ...
        playBean12.setSample("投注方案：包胆3：开奖号码：前三位3XX或者33X，即中前三组选三，前三位3XY，即中前三组选六");
        ...
        playBean13.setSample("投注方案：和值尾数8 开奖号码：前三位936，和值尾数为8，即中和值尾数。");
        ...
        playBean14.setSample("投注方案：豹子顺子对子 开奖号码：前三位888，即中豹子；前三位678，即中顺子；前三位558，即中对子。");
    ...
    private void initQEData(){
        ...
        playBean1.setSample("投注方案：58 开奖号码前两位：58，即中前二直选。");
        ...
        playBean2.setSample("投注方案：58 开奖号码前两位：58，即中前二直选。");
        ...
        playBean3.setSample("投注方案：和值1 开奖号码前两位：01或10，即中前二和值。");
        ...
        playBean4.setSample("投注方案：跨度9 开奖号码：90***，最大值9与最小值0相减之差即为跨度值，当所选号与跨度号码相同，即为中奖。");
        ...
        playBean5.setSample("投注方案：58 开奖号码：前两位 58 或 85(顺序不限，不含对子号)，即为中奖。");
        ...
        playBean6.setSample("投注方案：58 开奖号码：前二位 58 或者 85(顺序不限，不含对子号)，即中前二组选。");
        ...
        playBean7.setSample("投注方案：和值1 开奖号码前两位：01或10(顺序不限，不含对子号)，即中前二组选。");
        ...
        playBean8.setSample("投注方案：包胆8 开奖号码：前二位 8×，且×不等于8，即中前二组选。");
    ...
    private void initBDWData(){
        ...
        playBean1.setSample("投注方案：1 开奖号码：前三位，至少出现1个1，即中前三一码不定位。");
        ...
        playBean2.setSample("投注方案：12 开奖号码：前三位，至少出现1和2各一个，即中前三二码不定位。");
        ...
        playBean3.setSample("投注方案：1 开奖号码：后三位至少出现1个1，即中后三一码不定位。");
        ...
        playBean4.setSample("投注方案：12 开奖号码：后三位至少出现1和2各一个，即中后三二码不定位。");
        ...
        playBean5.setSample("投注方案：1 开奖号码：前四位至少出现1个1，即中前四不定位。");
        ...
        playBean6.setSample("投注方案：1 开奖号码：前四位至少出现1个1，即中前四不定位。");
        playBean6.setPlayTypeExplain("从0-9中任意选择1个以上号码，每组由一个号码组成，只要开奖号码万、千、百、十位中包含所选号码，即为中奖。（同个号码出现多次只计一次中奖）");
        playBean6.setSingleExplain("从0-9中任意选择1个以上号码。 ");
        ...
        playBean7.setSample("投注方案：1 开奖号码：后四位至少出现1个1，即中后四不定位。");
        ...
        playBean8.setSample("投注方案：12 开奖号码：后四位至少出现1和2各一个，即中后四二码不定位。");
        ...
        playBean9.setSample("投注方案：12 开奖号码：至少出现1和2各一个，即中五星二码不定位。");
        ...
        playBean10.setSample("投注方案：123 开奖号码：至少出现1和2及3各一个，即中五星三码不定位。");
