...
public class ListTool {
    ...
    /**
     * @see {@link ArrayTool#getLast(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getLast(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V)ArrayTool.getLast(sourceList.toArray(), value, true);
    }

    /**
     * @see {@link ArrayTool#getNext(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getNext(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V)ArrayTool.getNext(sourceList.toArray(), value, true);
    }
